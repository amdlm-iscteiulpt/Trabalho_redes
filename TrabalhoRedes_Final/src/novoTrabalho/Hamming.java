...
public class Hamming {
	...
	public Trama calculoHamming(Trama dados) {
		...
		Trama tramaTransmitida = new Trama("" + p1 + p2 + listaDados.get(0)
				+ p4 + listaDados.get(1) + listaDados.get(2)
				+ listaDados.get(3));
	...
	public boolean errosHamming(Trama tramaRecebida){
		...
		if(posicao!=0){
			System.out.println("existe um erro na posicao"+ posicao);
			return true;
		}
		else{
			System.out.println("nao existem erros");
			return false;
		}
